...
<FORM id=form1 name=form1 action="${pageContext.request.contextPath}/DoctorLogin" method=post>
...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0 >
  ...
  <TR>
    <TD>
      <TABLE height=700 cellPadding=0 width=1300 border=0>
        <TBODY>
        <TR>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName 
                  style="WIDTH: 130px" name=loginname></TD>
