				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：病人管理 &gt; 病情列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${list }" var="healthInfo">
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>${healthInfo.spressure }mmHg</TD>
													<TD>${healthInfo.dpressure }mmHg</TD>
													<TD>${healthInfo.temperature}℃</TD>
													<TD>${healthInfo.bsugar }mmol/l</TD>
													<td>${healthInfo.boxygen}%</td>
													<td>${healthInfo.hearterate}bpm</td>
													<td>${healthInfo.regDate }</td>
													<td>${healthInfo.preresult}</td>
													<!--  
													<TD>
